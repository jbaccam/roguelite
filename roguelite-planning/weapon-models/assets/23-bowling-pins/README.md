...
One reusable Bowling Pin item, following the final user scope. The reference may show multiple examples; this deliverable intentionally models one.
...
Rebuild: Blender 5.2 --background --threads 4 --python ../../batches/juggler_utility/build_utility.py -- 23
